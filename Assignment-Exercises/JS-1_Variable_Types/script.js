...
// Using let
let name = "Kenzo Ragundiaz"; // Define a string here, e.g., "Juan Cruz"
let age = 21; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["hosting", "learning japanese", "studying different cultures"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
// Using const
const pi = 3.1415926535897932; // Define a number here, e.g., 3.14159
const birthYear = 2003; // Define a number here, e.g., 1990
const isEmployed = false; // Define a boolean here, e.g., true or false
const favoriteBooks = ["JAPANESE STORIES FOR BEGINNERS", "JFZ", "Geronimo Stilton: The Lake Monster"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "札幌市"; // Define a string here, e.g., "New York"
var temperature = 1; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["Black", "White", "Green"]; // Define an array here, e.g., ["red", "green", "blue"]
